...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="dashboard-professional.html">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="dashboard-professional.html">
            <i class="material-symbols-rounded opacity-5">dashboard</i>
            <span class="nav-link-text ms-1">Dashboard</span>
          </a>
        </li> 
        <li class="nav-item">
          <a class="nav-link text-dark" href="profesionalTables/Tableprofessional.html">
            <i class="material-symbols-rounded opacity-5">person</i>
            <span class="nav-link-text ms-1">Perfil</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="profesionalTables/billetera.html">
            <i class="material-symbols-rounded opacity-5">receipt_long</i>
            <span class="nav-link-text ms-1">Billetera</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="profesionalTables/tableProfesionalService.html">
            <i class="material-symbols-rounded opacity-5">table_view</i>
            <span class="nav-link-text ms-1">Servicios</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="profesionalTables/serviceForm.html">
            <i class="material-symbols-rounded opacity-5">table_view</i>
            <span class="nav-link-text ms-1">Registrar servicio</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="profesionalTables/serviceCategoryForm.html">
            <i class="material-symbols-rounded opacity-5">table_view</i>
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav d-flex align-items-center  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="sign-in-professional.html" class="nav-link text-body font-weight-bold px-0">
    ...
    <div class="container-fluid py-2">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card">
            <div class="card-body">
              <h6 class="mb-0 ">Visitas a tu perfil</h6>
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card ">
            <div class="card-body">
              <h6 class="mb-0 "> Servicios completados por mes </h6>
              <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) de aumento en las suscripciones. </p>
              <div class="pe-2">
                <div class="chart">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Servicios en proceso</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">30 hechos</span> este mes
                  </p>
                </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Servicio de corte de pasto</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Servicio de riego</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Servicio de plantamiento</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Diseño de jardín</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Mantenimiento de césped</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Remoción de hojas y desechos</h6>
                          </div>
                        </div>
                      </td>
                      <td>
    ...
    new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
          ...
          fill: true,
          data: [12, 23, 13, 44, 25, 36, 27, 18, 9, 30, 31, 22],
          maxBarThickness: 6
