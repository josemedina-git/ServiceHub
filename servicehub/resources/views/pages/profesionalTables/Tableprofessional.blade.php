                    ...
                    <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" href="tableProfesionalService.html" role="tab"
                                        aria-selected="false">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" href="billetera.html" role="tab"
                                        aria-selected="false">
                                        <i class="material-symbols-rounded text-lg position-relative">settings</i>
                                        <span class="ms-1">Billetera</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-end">
                                            ...
                                            <a href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <i class="fas fa-trash-alt text-danger text-sm ms-3"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <p class="text-sm">
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">Experiencia:</strong> &nbsp; Soy Juan
                                            Pérez, carpintero con más de 15 años de experiencia en el
                                            diseño, fabricación y reparación de muebles a medida.</li>

                                    </p>
                                    <hr class="horizontal gray-light my-4">
                                    <ul class="list-group">
                                        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                                                class="text-dark">Nombre y Apellidos:</strong> &nbsp; Juan Pérez López
                                        </li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">CURP:</strong> &nbsp; PELP850101HDFRZN08
                                        </li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">RFC:</strong> &nbsp; PELP850101KX3 </li>
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                                class="text-dark">DISPONIBILIDAD:</strong> &nbsp; Tiempo Completo </li>
