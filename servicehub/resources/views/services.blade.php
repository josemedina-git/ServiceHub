            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Precio:</strong> {{ $service->PriceHour }}</p>

                        @if($service->professionalServices && $service->professionalServices->professional)
                        <p class="card-text"><strong>Profesional:</strong> {{ $service->professionalServices->professional->Name }}</p>
                        <p class="card-text"><strong>Experiencia:</strong> {{ $service->professionalServices->professional->ExperienceYears }} años</p>
                        @else
                        <p class="card-text"><strong>Profesional:</strong> No asignado</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="service_profile" style="display: flex; flex-direction: column; align-items: center; background: #fff; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; width: 350px; height: 550px;">
                ...
                <div class="profile-detail-box" style="text-align: center; margin-top: 15px; flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
                    <div style="flex-grow: 1; overflow: hidden;">
                        <h4 class="service-name" style="color: #333; font-size: 24px; margin-bottom: 10px;">Servicio de Plomería</h4>
                        ...
                        <p style="color: #666; font-size: 14px; margin: 10px 0;">
                            Ofrecemos servicios de plomería profesional, reparación de fugas, instalación de tuberías y mantenimiento preventivo. Servicios confiables y personalizados.
                        </p>
                    </div>
                    <button style="background: #884cdc; color: #fff; border: none; padding: 10px 20px; border-radius: 5px; font-size: 14px; cursor: pointer; margin-top: 10px;">
                        <a href="{{route('profileservice')}}" style="text-decoration: none; color: #fff;">Ver más</a>
                    </button>
                </div>
            </div>
